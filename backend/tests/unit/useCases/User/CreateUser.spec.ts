...
describe('CreateUserUseCase', () => {
  ...
  it('should create a new user', async () => {
    ...
    expect(userRepository.findByEmail).toHaveBeenCalledWith(createUserRequestDTO.email);
  ...
  it('should throw an error if user already exists', async () => {
    ...
    userRepository.findByEmail = vi.fn().mockResolvedValueOnce(createUserRequestDTO);
    const result = await createUserUseCase.execute(createUserRequestDTO);
